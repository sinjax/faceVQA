...
class QuestionGenerator(object):
    def __init__(self, question_config, host="192.168.0.3:9999", namespace="kb"):
        # http://192.168.0.3:9999/blazegraph/namespace/kb/sparql
...
if __name__ == '__main__':
    gen = QuestionGenerator("templates/questions.json")
    people = gen.list_people()
    one_person = _as_uri(people["results"]["bindings"][0]["person"])
    for person_question_answers in gen.generate_questions(one_person):
